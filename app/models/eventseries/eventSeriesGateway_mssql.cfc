<cfcomponent displayname="eventSeriesGateway_mssql" extends="eventSeriesGateway">
	...
	<cffunction name="addReminder" access="public" returntype="void" output="false">
		...
		<cfquery name="q_series_reminder" datasource="#variables.dsn#">
		...
		<cfif val(q_seriesDsid.recordCount) gt 0 and val(q_reminderDsid.recordCount) gt 0 and val(q_series_reminder.recordCount) eq 0>
			<cfquery name="q_insert_series_reminder" datasource="#variables.dsn#">
