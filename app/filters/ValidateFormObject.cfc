<!---
	$Id: ValidateFormObject.cfc,v 1.2 2003/10/13 16:51:18 scorfield Exp $
	...
	<event-filters>
		...
		<event-filter name="validateFormObject" type="MachII.filters.ValidateFormObject" />
		...
	</event-filters>
	...
	<event-handlers>
		...
		<event-handler event="foo">
			<filter name="formObjectBeaner">
				...
				<parameter name="formObjectType" value="my.models.Bar" />
			</filter>
...
<cfcomponent extends="MachII.framework.EventFilter" display="ValidateFormObject filter"
	hint="I am an event filter that manages validation of a form object.">
