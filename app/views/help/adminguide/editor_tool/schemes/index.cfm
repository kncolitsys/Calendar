<h3 class="bp-subtitle">Edit Schemes</h3>

<div class="bp-text">
<p>Schemes are simply cascading stylesheets that allow calendar editors to manage the various fonts, colors, et cetera used in the calendarInfusion interface.	Virtually every element within the calendarInfusion interface has a class associated with it and these classes can be modified using the scheme stylesheets.	There are two types of schemes: global schemes and local schemes.	Global schemes are available to every calendar and are created using the Administrator Tool.	Local schemes are available only to the calendar in which the scheme was created and are created using the Editor Tool.	calendarInfusion ships with a number of pre-defined global schemes.</p>
...
<p><span class="bp-heading">Create a new local scheme</span><br>
	To create a new scheme, follow these steps:
	<ol>
		<li>Click on the <span class="bn-input">Schemes</span> link in the navigation menu of the Editor Tool.</li>
...
<p><span class="bp-heading">Modify an existing local scheme</span><br>
...
<p><span class="bp-heading">Delete an existing local scheme</span><br>
